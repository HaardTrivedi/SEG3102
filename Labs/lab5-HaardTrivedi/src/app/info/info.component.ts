...
import { InfoDbService } from './firebase/info-db.service'
...
export class InfoComponent implements OnInit {
  ...
  constructor(private builder: FormBuilder,  private store: InfoDbService) { }
  ...
  onSubmit(): void {
    ...
    this.store.addInfo(this.fname, this.lname, this.phonenum, this.mail);
    this.infoForm.reset();
  }
